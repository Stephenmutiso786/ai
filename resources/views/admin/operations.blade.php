...
@if(session('run_error_admin'))<div class="mb-4 border border-line bg-ink/60 text-muted rounded px-4 py-3 font-mono text-xs">AI detail: {{session('run_error_admin')}}</div>@endif
