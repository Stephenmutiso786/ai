...
<div class="flex gap-3 mb-8"><a class="bg-brass text-ink px-4 py-2 rounded text-sm" href="{{ route('admin.ai-lab.models') }}">Manage models</a><a class="border border-line px-4 py-2 rounded text-sm" href="{{ route('admin.ai-lab.datasets') }}">Datasets</a><a class="border border-line px-4 py-2 rounded text-sm" href="{{ route('admin.ai-lab.jobs') }}">Training jobs</a></div>
